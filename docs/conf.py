...
project = 'django-websocket-redis'
...
latex_documents = [
  ('index', 'django-websocket-redis.tex', 'django-websocket-redis Documentation',
   'Jacob Rief', 'manual'),
]
...
man_pages = [
    ('index', 'django-websocket-redis', 'django-websocket-redis Documentation',
     ['Jacob Rief'], 1)
]
...
texinfo_documents = [
  ('index', 'django-websocket-redis', 'django-websocket-redis Documentation',
   'Jacob Rief', 'django-websocket-redis', 'One line description of project.',
   'Miscellaneous'),
]
